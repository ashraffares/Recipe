...
ActiveRecord::Schema.define(version: 2021_11_20_115015) do
  ...
  create_table "inventory_foods", force: :cascade do |t|
    ...
    t.index ["recipe_id"], name: "index_inventory_foods_on_recipe_id"
  end
  ...
  add_foreign_key "inventory_foods", "recipes"
